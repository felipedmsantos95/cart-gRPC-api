...
module.exports = {
    ...
    async GetServiceDiscount(id) {
        ...
        return new Promise((resolve, reject) =>
            DiscountService.DiscountClient.GetDiscount(
                { productID: id },
    ...
    async ProductDetails(product) {
        ...
        if (productExists) {
            ...
            if (serviceDiscount.percentage)
                productDiscount = this.DiscountCalc(
                    totalAmount,
    ...
    async BlackFridayCheck(products, headerDate) {
        ...
        if (CartChekout.is_invalid) {
            const checkInvalidProduct = this.PickProductsNotFound(
                CartChekout.products_details,
            );
